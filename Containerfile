...
RUN rpm-ostree install gnome-shell-extension-appindicator gnome-shell-extension-dash-to-dock gnome-shell-extension-gsconnect nautilus-gsconnect gnome-shell-extension-sound-output-device-chooser gnome-shell-extension-apps-menu gnome-shell-extension-caffeine gnome-shell-extension-places-menu gnome-shell-extension-user-theme openssl just podman-docker zsh htop nvme-cli glances ncdu && \
